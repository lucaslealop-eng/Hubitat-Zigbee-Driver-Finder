...
async function scrape() {
    ...
    fs.writeFileSync('./data/db_hpm_scraped.json', `${JSON.stringify({ version: '2.2.0', devices: zigbeeDevices }, null, 2)}\n`);
    fs.writeFileSync('./data/db_zwave_hpm_scraped.json', `${JSON.stringify({ version: '2.2.0', devices: zwaveDevices }, null, 2)}\n`);
